$(document).on('click', '#done', function(){
    ...
    if(title != "" && date != "" && rent != "" && rent >= 0 && category != 0 && size != "" && adsfor != 0 && areatype != 0 && condition != 0 && floor != "" && details != "" && bedroom >= 0 && bedroom !="" && ranna != "" && ranna >= 0 && baranda != "" && baranda >=0 && face != 0 && division != 0 && city !=0 && area != 0 && sort !=""){
